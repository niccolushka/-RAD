...
- **Результат анализа**: модель/алгоритм классификации, класс эмоции, доверие, метрики и визуализация.

Карточка пациента показывает список сеансов, связанных файлов и результатов анализа, а через Django Admin доступно полное управление данными.
